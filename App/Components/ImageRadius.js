...
export default class ImageRadius extends Component {
  ...
  render() {
    return (
      <View
        style={this.props.height ? styles(this.props).imageContainer : styles(this.props).imageContainerAuto}
        ...
        <Image
          style={this.props.height ? styles(this.props).image : styles(this.props).imageAuto}
          {...this.props}
        />
      </View>
    )
