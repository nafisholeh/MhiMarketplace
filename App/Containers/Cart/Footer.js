      ...
      .then(res => {
        ...
        if (status === "out of stock") {
          const outOfStockProducts =
            ...
            products.map(({ _id, qty }) => ({ _id, maxStock: qty }));
          ...
          InAppNotification.error(
            "Checkout pesanan gagal",
            `Maaf, ada ${outOfStockTotal}produk yang melebihi stok`
          );
          return;
        }
          ...
          {(syncCartItem, { loading, error, data }) => {
            return (
              <ButtonSecondary
                ...
                disabled={loading || isInitiatingCheckout || !isCheckoutValid}
