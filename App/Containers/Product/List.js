...
class List extends Component {
  renderVerticalItem = (type, data) => <ItemVertical data={data} />;

  renderHorizontalItem = (type, data) => <ItemHorizontal data={data} />;
            ...
            if (Array.isArray(products) && products.length) {
              return (
                <OptimizedList
                  ...
                  itemWidth={
                    isHorizontal
                      ? METRICS.DEVICE_WIDTH / 2 - moderateScale(10)
                      : METRICS.DEVICE_WIDTH
                  }
                  itemHeight={
                    isHorizontal ? moderateScale(215) : moderateScale(128)
                  }
                  data={products}
                  renderRow={
                    isHorizontal
