  ...
  render() {
    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <Query query={FETCH_ORDER_DETAIL} variables={{ _id: checkoutId }}>
          {({ loading, error, data, refetch }) => {
            ...
            return (
              ...
              >
                <View style={{ marginVertical: METRICS.HUGE }}>
                  <View
                    style={{
                      flexDirection: "row",
                      justifyContent: "space-between",
                ...
                <View style={{ marginBottom: METRICS.EXTRA_HUGE }}>
                  <Text
                    style={[
                      styles.rowTitle,
                  ...
                  {how_to_pay ? (
                    <HTMLView value={how_to_pay} stylesheet={htmlStyles} />
                  ) : (
                    <Text style={htmlStyles.p}>
                      Belum ada info cara pembayaran. Silahkan hubungi MHI untuk
