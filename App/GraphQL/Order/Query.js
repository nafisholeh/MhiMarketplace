...
export const FETCH_SENDING_CONSUMER_LIST = gql`
  query fetchSendingOrdersConsumer($courier_id:String, $user_id:String) {
    sendingOrdersConsumer(courier_id:$courier_id, user_id:$user_id) {
      _id
      transaction_id
      total_cost
      shipping_address {
